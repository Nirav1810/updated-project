...
export const classService = {
  ...
  enrollStudent: async (classId, studentId) => {
    const response = await api.post(`/teacher/classes/${classId}/enroll`, { studentId });
    return response.data;
  },
  ...
  teacherEnrollStudent: async (classId, studentId) => {
    const response = await api.post(`/classes/${classId}/enroll-student`, { studentId });
    return response.data;
  },
  
  // Teacher batch enroll students
  teacherBatchEnrollStudents: async (classId, studentIds) => {
    const response = await api.post(`/classes/${classId}/batch-enroll`, { studentIds });
    return response.data;
  },
